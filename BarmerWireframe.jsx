    ...
    <div className="flex flex-col bg-white">
      ...
      <div className="flex items-center overflow-hidden" style={{ minHeight: 220 }}>
        <div className="flex-1 px-6" style={{ minWidth: 0, display:"flex", alignItems:"center", justifyContent:"center" }}>
          <img src="data:image/jpeg;base64,PLACEHOLDER" alt="Hallo Anna"
      ...
      <div className="px-6 pt-6 pb-2">
        ...
        <button className="w-full flex items-center gap-4 py-4 text-left">
          <div className="shrink-0" style={{ width: 80, height: 56 }}>
            <img src="data:image/jpeg;base64,PLACEHOLDER" alt="Versicherung" style={{ width:"100%", height:"100%", objectFit:"contain" }}/>
          </div>
        ...
        <button className="w-full flex items-center gap-4 py-4 text-left">
          <div className="shrink-0" style={{ width: 80, height: 56 }}>
            <img src="data:image/jpeg;base64,PLACEHOLDER" alt="Gesundheit" style={{ width:"100%", height:"100%", objectFit:"contain" }}/>
          </div>
          <div className="flex-1 text-[19px]"
               style={{ fontWeight: 700, color: C.black, letterSpacing: "-0.01em" }}>
            Gesundheit
        ...
        <button className="w-full flex items-center gap-4 py-4 text-left">
          <div className="shrink-0" style={{ width: 80, height: 56 }}>
            <img src="data:image/jpeg;base64,PLACEHOLDER" alt="Familie" style={{ width:"100%", height:"100%", objectFit:"contain" }}/>
          </div>
          <div className="flex-1 text-[19px]"
               style={{ fontWeight: 700, color: C.black, letterSpacing: "-0.01em" }}>
            Familie
